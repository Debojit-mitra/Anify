...
public class Constants {
    ...
    public static final String PREF_ANIME_IMAGE_WIDGET_INITIALIZED = "anime_image_widget_initialized";
    ...
    public static final String PREF_ANIME_IMAGE_CATEGORY = "anime_image_category";
    ...
    public static final String ACTION_HOMESCREEN_FROM_APP = "com.bunny.entertainment.anify.widgets.ACTION_HOMESCREEN_FROM_APP";
    ...
    public static final String ACTION_STOP_AUTO_UPDATE = "com.bunny.entertainment.anify.widgets.ACTION_STOP_AUTO_UPDATE";
