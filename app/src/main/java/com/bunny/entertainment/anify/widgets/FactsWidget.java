package com.bunny.entertainment.anify.widgets;
...
public class FactsWidget extends AppWidgetProvider {
    ...
    private boolean canPeformUpdate = false;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (ACTION_REFRESH.equals(action) || ACTION_AUTO_UPDATE.equals(action)) {
            ...
            long updateInterval = getUpdateIntervalMillis(context, PREF_FACT_UPDATE_INTERVAL);
            Log.e("PREF_FACT_UPDATE_INTERVAL", PREF_FACT_UPDATE_INTERVAL);
           // if (currentTime - getLastUpdateTime(context) >= updateInterval) {
    ...
    private void scheduleAutoUpdate(Context context) {
        ...
        long intervalMillis = getUpdateIntervalMillis(context, PREF_FACT_UPDATE_INTERVAL);
    ...
    //getter
    private long getUpdateIntervalMillis(Context context, String prefName) {
        SharedPreferences prefs = context.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE);
